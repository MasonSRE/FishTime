...
enum AppStrings {
    ...
    enum Report {
        ...
        static let weeklyMemorialTitle = "本周摸鱼纪念卡"
        static let monthlyMemorialTitle = "本月摸鱼纪念卡"
        static let periodRecordedDays = "记录天数"
        static let periodAverageScore = "平均劳动分"
        static let periodTotalActiveMinutes = "总活跃分钟"
        static let periodMaxIdleMinutes = "最长沉寂分钟"
        static let periodVerdictHigh = "工位高燃期"
